	...
	<div id="container" class="cf">
		<div id="header" class="cf">
			...
			<div id="header-title">
				...
				<h4>कृषि विभाग</h4>
				<h4>मध्यमान्चल क्षेत्रिय कृषि निर्देशनालय</h4>
				<h3>जिल्ला कृषि विकास कार्यालय, काभ्रेपलान्चोक</h3>
				<p>०११ ४९०५८९</p>
			</div>
			<div id="header-flag">
				<img src="images/nepalflag.gif" style="width: 48%;margin-top: 4%;margin-left: 40%;" />
			</div>
